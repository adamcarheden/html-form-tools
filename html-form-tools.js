...
/***/ function(module, exports) {
	...
	const IntegerInput = function (input, callbacks = {}, opts = {}) {
		...
		var ufmt = false;
		if (newOpts.commafy) {
			fmt = stackFormats(callbacks, 'format', function (value, cursorPos) {
				return commafy(value, cursorPos);
			});
			ufmt = stackFormats(callbacks, 'unformat', function (value, cursorPos) {
				return uncommafy(value, cursorPos);
			});
		} else {
